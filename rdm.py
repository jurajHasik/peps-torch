...
def rdm2x2(coord, ipeps, env):
    ...
    print("C2X2 RU "+str(coord)+"->"+str(ipeps.vertexToSite(coord))+" (1,-1): "+str(C2x2_RU.size()))
    ...
    #    |/23
    # 1--C2x2
    print("C2X2 RD "+str(coord)+"->"+str(ipeps.vertexToSite(coord))+" (1,1): "+str(C2x2_RD.size()))
    ...
    print("C2X2 LD "+str(coord)+"->"+str(ipeps.vertexToSite(coord))+" (-1,1): "+str(C2x2_LD.size()))
