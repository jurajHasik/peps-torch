...
def main():
    ...
    direction = (1, 0)  # r=0: site0 B; r=1: site1 C; r=2: site1 B; r=3: site2 C; r=4: site2 B; ...
    spec_x = transferops.get_Top_spec(args.top_n, coord, direction, state, ctm_env_init)
    direction = (0, 1)  # r=0: site0 C; r=1: site1 A; r=2: site1 C; r=3: site2 A; r=4: site2 C; ...
    ...
    # filename = "{}/correlation_{}.pkl".format(args.output_path, args.input_prefix)
    # with open(filename, "wb") as fp:
    #     pickle.dump(correlation_dict, fp)
