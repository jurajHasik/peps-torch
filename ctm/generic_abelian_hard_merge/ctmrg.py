...
from ctm.generic_abelian_hard_merge.env_abelian import ENV_ABELIAN
from ctm.generic_abelian_hard_merge.ctm_components import *
from ctm.generic_abelian_hard_merge.ctm_projectors import *
...
def run(state, env, conv_check=None, ctm_args=cfg.ctm_args, global_args=cfg.global_args): 
    ...
    for coord,A in state.sites.items():
        ...
        a= a.fuse_legs_hard( axes=((0,1),(2,3),(4,5),(6,7)) )
        sitesDL[coord]=a
...
def absorb_truncate_CTM_MOVE_UP_c(*tensors):
    ...
    nC1= nC1.fuse_legs_hard( axes=((0,1),2) )
    ...
    nC2= nC2.fuse_legs_hard( axes=((0,2),1) )
    ...
    #                       1(-1)           |
    #                                        --1->0(-1)
    Pt2= Pt2.unfuse_legs_hard(axes=0)
    ...
    nT = nT.fuse_legs_hard( axes=(0,(1,3),2) )
...
def absorb_truncate_CTM_MOVE_LEFT_c(*tensors):
    ...
    nC2= nC2.fuse_legs_hard( axes=((0,1),2) )
    ...
    nT= nT.fuse_legs_hard( axes=(0,(1,2),3) )
...
def absorb_truncate_CTM_MOVE_DOWN_c(*tensors):
    ...
    nC1 = nC1.fuse_legs_hard( axes=((0,2),1) )
