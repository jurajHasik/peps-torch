...
from ipeps.ipess_kagome_u1 import IPESS_KAGOME_U1SYM, write_coeffs, read_coeffs
...
def main():
    ...
    state = IPESS_KAGOME_U1SYM(tensors_triangle, tensors_site, coeffs_triangle, coeffs_site, sym_up_dn=bool(args.sym_up_dn),
