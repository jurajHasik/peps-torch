...
Specialized class for iPEPS on Kagome lattice, where sites `s0,s1,s2` on 
...
.. autoclass:: ipeps.ipeps_kagome.IPEPS_KAGOME
    :show-inheritance:
    :members:

.. automodule:: ipeps.ipeps_kagome
    :exclude-members: IPEPS_KAGOME
    :members: